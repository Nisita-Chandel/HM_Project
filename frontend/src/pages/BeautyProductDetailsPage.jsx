// src/pages/BeautyProductDetailsPage.jsx
...
export default function BeautyProductDetailsPage() {
  const { id } = useParams();
  ...
  const similarProducts = useMemo(
    () => BeautyProducts.filter((p) => p.id !== id).slice(0, 4),
    [id]
  );
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="p-10 text-center bg-white rounded-xl shadow">
          ...
          <Link to="/beauty" className="underline text-blue-600">
            Go Back to Beauty Corner
          </Link>
        </div>
      </div>
    );
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-10 bg-white p-6 rounded-2xl shadow">
          ...
          <div className="flex flex-col">
            ...
            {/* Sizes (if relevant, like ml or “Standard”) */}
